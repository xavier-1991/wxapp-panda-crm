<template>
    <view class="yu-datetime-picker">
        <view class="yu-datetime-mask"
              :class="{'show':showPicker}"
              @tap="maskClick"
              @touchmove.stop.prevent
              catchtouchmove="true"></view>
        <view class="yu-datetime-content"
              :class="{'show':showPicker}">
            <view class="yu-datetime-hd"
                  @touchmove.stop.prevent
                  catchtouchmove="true">
                <view class="yu-datetime-btn"
            ...
            <view class="yu-datetime-view">
                <picker-view v-if="isAll"
                             :indicator-style="itemHeight"
                             :value="values"
                             @change="bindChange">
                    <picker-view-column>
                        <view class="yu-datetime-item"
                    ...
                    <picker-view-column>
                        <view class="yu-datetime-item"
                              v-for="(item,index) in dateObj.hours"
                              :key="index">{{item}}时</view>
                    </picker-view-column>
                    <picker-view-column>
                        <view class="yu-datetime-item"
                              v-for="(item,index) in dateObj.minutes"
                              :key="index">{{item}}分</view>
                    </picker-view-column>
                    <picker-view-column :hidden="true">
                        <view class="yu-datetime-item"
                              v-for="(item,index) in dateObj.seconds"
                ...
                <picker-view v-else
                    ...
                    <picker-view-column class="yu-picker-column">
                        <view class="yu-datetime-item"
                              v-for="(item,index) in dateObj.dates"
                              :key="index">{{item}}</view>
                    </picker-view-column>
                    <picker-view-column>
                        <view class="yu-datetime-item"
    ...
    methods: {
        initDate() {
            ...
            if (_this.value) {
                ...
                if (_this.isAll) {
                    values[0] =
                        valueDateArr[0] - _this.startYear > 0
                            ? valueDateArr[0] - _this.startYear
                            : 0;
            ...
            if (_this.isAll) {
                ...
                _this.selectRes = `${_this.formatNum(_this.startYear) +
                    "-01-01 00:00:00"}`;
            } else {
                _this.selectArr = [
                    _this.formatNum(_this.year),
